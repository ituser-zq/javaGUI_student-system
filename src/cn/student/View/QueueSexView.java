...
public class QueueSexView {
	 ...
	 */
	public QueueSexView(String sno) {
		this.sno=sno;
		initialize(sno);
	}
	...
	private void initialize(String sno) {
		...
		String[][] str =StudentAction.getSex(sno);
		...
		sl_jPanelCenter.putConstraint(SpringLayout.SOUTH, jScrollPane, -277, SpringLayout.SOUTH, jPanelCenter);
