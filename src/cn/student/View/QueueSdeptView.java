...
public class QueueSdeptView {
	 ...
	 */
	public QueueSdeptView(String sno) {
		this.sno=sno;
		initialize(sno);
	}
	...
	private void initialize(String sno) {
		...
		String[][] str =StudentAction.getDept(sno);
		...
		sl_jPanelCenter.putConstraint(SpringLayout.SOUTH, jScrollPane, -280, SpringLayout.SOUTH, jPanelCenter);
